...
UploadGroupApp.controller("ApiUploadGroupController", function ($scope, $http) {
    ...
    $http.get('/api/ApiUploadGroupController/GetGroupData/', {
        params: {
            Compid: compid,
        }
    ...
    $scope.addrow = function (event) {
        ...
        if (this.newChild.GROUPNM != "") {
            $http.post('/api/ApiUploadGroupController/grid/addData', this.newChild).success(function (data, status, headers, config) {
...
$scope.update = function () {
    ...
    if (groupName != "") {
        $http.post('/api/ApiUploadGroupController/grid/UpdateData', this.testitem).success(function (data) {
            if (data.GROUPID != 0) {
...
$scope.deleteItem = function () {
    ...
    if (id != "") {
        ...
        $http.post('/api/ApiUploadGroupController/grid/DeleteData', this.testitem).success(function (data) {
