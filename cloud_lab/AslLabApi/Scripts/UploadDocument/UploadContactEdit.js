...
UploadEditContactApp.controller("ApiUploadEditController", function ($scope, $http) {
    ...
    $scope.update = function () {
        ...
        if (this.testitem.From_GROUPID != "") {
            $http.post('/api/ApiUploadExchangeContactController/grid/UpdateData', this.testitem).success(function (data) {
    ...
    $scope.deleteItem = function () {
        ...
        if (id != "") {
            ...
            $http.post('/api/ApiUploadExchangeContactController/grid/DeleteData', this.testitem).success(function (data) {
