...
using AS_RMS_Store_GL.Controllers.ASL;
using AS_RMS_Store_GL.Models;
using AS_RMS_Store_GL.Models.ASL;
using AS_RMS_Store_GL.Models.DTO;

namespace AS_RMS_Store_GL.Controllers.Api
{
    public class ApiUploadEditController : ApiController
    {
        RMS_Store_GL_DbContext db = new RMS_Store_GL_DbContext();
