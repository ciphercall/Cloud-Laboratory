...
namespace AslLabApi.Controllers
{
    public class TransactionController : AppController
    {
                ...
                if (command == "Create")
                {
                    ...
                    var duplicate_data_test = (from n in db.GlStransDbSet
                                               where
                                                   ...
                                                   n.TRANSNO == model.AGlStrans.TRANSNO
                                               select n).ToList();
        ...
        public JsonResult Update_SelectTransNo(Int64 changedtxt,string type)
        {
            ...
            var selectdata = from n in db.GlStransDbSet where n.COMPID == compid && n.TRANSNO == changedtxt && n.TRANSTP == type select new { n.Gl_StransID, n.TRANSDT, n.TRANSTP, n.TRANSFOR, n.TRANSMY, n.COSTPID, n.TRANSMODE, n.DEBITCD, n.CREDITCD, n.REMARKS, n.AMOUNT, n.CHEQUEDT, n.CHEQUENO };
            ...
            var result = new { keyid = primaryid, For = transfor, date = chequedate, costpool = costpoolid, mode = transmode,firstdebittext=debitaccount,debitCD=debitcd, debit = Debitlist,firstcredittext=creditaccount,creditCD=creditcd, credit = Creditlist, cheque = chequeno,ChequeDate=chequedate, remarks = remarks, amount = amount };
