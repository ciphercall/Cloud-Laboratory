                ...
                else
                {
                    ...
                    if (maxData == 0)
                    {
                        ...
                        if (asluserco.EMAILID != null)
                        {
                            ...
                            clientComapny.Credentials = new NetworkCredential("admin@cloudlabbd.com", "@Mnbvc123");
                    ...
                    if (asluserco.EMAILID!=null)
                    {
                        ...
                        mail.From = new MailAddress("admin@cloudlabbd.com");
                        mail.Subject = "Mail Confirmation";
                        mail.Body = "Lab Management System.\n\n" + Environment.NewLine + "Hi, " + asluserco.USERNM + Environment.NewLine
                        ...
                        client.Credentials = new NetworkCredential("admin@cloudlabbd.com", "@Mnbvc123");
